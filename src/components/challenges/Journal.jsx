                ...
                <div className='flex flex-col md:gap-4 pt-4 md:flex-row'>
                    ...
                    <div className='flex flex-col pt-1'>
                        <div className='flex items-center justify-between md:justify-start md:gap-3'>
                            ...
                            <a href={props.maplink} target='_blank' className='text-[10px] text-gray-400 underline'>View on Google Maps</a>
                        </div>
                        <h1 className='pt-2 text-xl font-bold'>{props.title}</h1>
                        <p className='text-xs font-semibold tracking-tighter text-gray-500'>{props.date}</p>
                        <p className='pt-2 pb-4 tracking-tighter text-gray-600 font-inter'>{props.text}</p>
                    </div>
                </div>
            </div>
        </>
