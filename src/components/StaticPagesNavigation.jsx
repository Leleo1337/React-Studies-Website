...
export default function StaticPageCards(){
    return(
        <div className="flex flex-col gap-4 lg:grid lg:grid-rows-1 lg:grid-cols-3 lg:justify-items-center px-12">
            <Link to="c1" className="card-style group bg-[url(/src/assets/img/challenges/homepage/c1Blur.png)] opacity-50 hover:opacity-70 hover:bg-[url(/src/assets/img/challenges/homepage/c1NoBlur.png)]">
            ...
            <Link to="c2" className="card-style group bg-[url(/src/assets/img/challenges/HomePage/c2blur.png)] opacity-50 hover:opacity-70 hover:bg-[url(/src/assets/img/challenges/HomePage/c2NoBlur.png)]">
